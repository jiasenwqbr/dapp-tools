...
pub fn compute_usd_price(reserves_store: &impl store::StoreGet<Vec<u8>>, reserve: &pb::pcs::Reserve) -> BigDecimal {
...
pub fn find_bnb_price_per_token(
    ...
    pairs_store: &impl store::StoreGet<Vec<u8>>,
    reserves_store: &impl store::StoreGet<Vec<u8>>,
) -> Option<BigDecimal> {
...
pub fn get_last_token(tokens: &impl store::StoreGet<Vec<u8>>, token_address: &str) -> pb::tokens::Token {
