...
- 智能合约不能自我执行
- 智能合约是一种被动的代理
- 智能合约不能肚子开始处理一个流程，也不能基于预设条件来调用它们自己的函数。
- 智能合约中的状态变化只有在另一个账户发送交易的时候才会发生。另一个账户包括：用户，预言机节点或者其他智能合约。
...
执行任何你想要运行的任何代码，同时让这个结果是去中心化执行并且是可验证的。

![image-20240923143558274](images/image-20240923143558274.png)



![image-20240923144002333](images/image-20240923144002333.png)
